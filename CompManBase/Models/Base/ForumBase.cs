...
namespace CompManBase.Models
{
    public class ForumBase : INotifyPropertyChanged
    {
        ...
        public static ForumMessage[] ForumMessages = new[]
        {
            ...
            new ForumMessage { Id = 6, NeedLevel = 5, Title = "Продажа программы финансовых транзакций", Message = "Продается программа быстрых финансовых транзакций с разных счетов через промежуточные оффшорные счета за 1000000 рублей", DoName = "Купить"},
        };
        #endregion
    }
}
