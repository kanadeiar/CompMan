...
namespace CompManBase.Models
{
    public class ForumBase : INotifyPropertyChanged
    {
        ...
        public static ForumMessage[] ForumMessages = new[]
        {
            ...
            new ForumMessage { Id = 6, NeedLevel = 5, Title = "Продажа программы использования VPN-туннелей", Message = "Продается программа максимальной маскировки с использованием множества VPN-туннелей за 200000 рублей", DoName = "Купить"},
            new ForumMessage { Id = 7, NeedLevel = 5, Title = "Продажа программы шифратора/дешифратора", Message = "Продается программа шифрования и расшифровывания любых файлов любого уровня защиты за 1000000 рублей", DoName = "Купить"},
        };
        #endregion
    }
}
